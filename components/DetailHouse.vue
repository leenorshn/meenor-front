<template>
    <div class="container mx-auto">
           <div class="relative flex justify-between overflow-auto bg-white shadow rounded-t-md">
      ...
      >
        ...
        <h5 class="text-base font-semibold text-gray-600">
          ...
          <div class="flex items-center justify-between w-full space-x-4">
            <nuxt-link :to="`/maison/${batiment.id}/edit`" class="p-2 text-blue-700 rounded-full hover:bg-blue-200">
            <Icon :iconName="`pencil`"/>
            </nuxt-link>
          <button class="p-2 text-orange-700 rounded-full hover:bg-orange-200">
        ...
        <div v-else >
          ...
          <div class="flex items-center">
            <button @click.prevent="saveNiveau()" class="block my-2 text-lg text-blue-600 border-b-2 border-transparent hover:border-blue-500">Save</button>
          <button @click.prevent="annulNiveau()" class="block my-2 text-lg text-orange-600 border-b-2 border-transparent hover:border-orange-500">Cancel</button>
          </div>
        </div>
        </div>
    ...
    <div v-if="batiment.totaleNiveaux == 0">
      <div
        class="p-4 mx-auto mt-16 space-y-3 bg-white rounded-md shadow-md "
      >
...
export default {
    ...
    methods:{
     ...mapActions({createNiveau:"house/createNiveau",deleteNiveau:"house/deleteNiveau"}),
    showCreateNiveau(){
